...
import { vendorsAPI, contractsAPI } from '../../config/api';
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="card">
          <div className="card-body">
            <p className="text-slate-600">Vendor creation form will be implemented here.</p>
          </div>
        </div>
      </div>
    );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-slate-900">{vendor.address || 'N/A'}</span>
                  </div>
                </div>
              </div>
                    ...
                    <div key={contract._id} className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-slate-600">
                          ...
                          Status: <Badge variant={contract.status === 'active' ? 'success' : 'warning'} text={contract.status} />
                        </p>
                      </div>
                      <Link
