...
# Trackr ITAM - One-Click Production Deployment Script
...
docker-compose -f docker-compose.prod.yml exec -T backend npm run migrate:up || print_warning "Migrations may have already been run"
