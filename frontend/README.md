...
- **Zustand** - State management (client-side UI state)
...
See `docs/IMPROVEMENTS_GUIDE.md` for more testing details.

### State Management

The project uses:
- **Zustand** for client-side UI state (preferences, favorites, etc.)
- **React Query** for server state (API data, caching)

```javascript
import { useSidebar, useDarkMode } from '@/store/useAppStore';
```

### Error Handling

Centralized error handling is available:
...
- **[Security Guide](./docs/SECURITY.md)** - Security best practices and token storage options
- **[Improvements Guide](./docs/IMPROVEMENTS_GUIDE.md)** - Complete guide to all improvements
