...
interface LicenseEntitlementViewProps {
  software?: Software;
  onClose?: () => void;
}

const LicenseEntitlementView = ({ software, onClose }: LicenseEntitlementViewProps) => {
  const { data: entitlements, isLoading } = useQuery<{ data: Assignment[] }>({
