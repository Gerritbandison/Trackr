...
import { FiDownload, FiFileText, FiFile, IconType } from 'react-icons/fi';
 ...
 */
const ExportMenu: React.FC<ExportMenuProps> = ({ onExport, formats = ['csv', 'pdf', 'excel'] }) => {
  const [isOpen, setIsOpen] = useState(false);

  const formatIcons: Record<string, IconType> = {
    csv: FiFileText,
    pdf: FiFile,
    excel: FiFile,
  };
